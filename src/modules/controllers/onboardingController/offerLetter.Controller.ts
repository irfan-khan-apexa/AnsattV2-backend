...
// //     //  decrypt full public URL
// //     const fullUrl = decrypt(encryptedUrl);

// //     //  extract ONLY KEY (this was missing)
...
// //     //  generate presigned url (your function is correct)
...
const getCompanyLetterRequests = async (
  ...
  try {
    ...
    if (letter_type) whereCondition.letter_type = letter_type;
